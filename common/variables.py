...
# Порт сервера по умолчанию для подключения клиентов
DEFAULT_PORT = 7777
# IP-адрес сервера по умолчанию для подключения клиентов
DEFAULT_IP_ADDRESS = '127.0.0.1'  # он же 'localhost'
CLIENT_SEND_MODE = 'send'
CLIENT_LISTEN_MODE = 'listen'

# Ключи для передачи серверу параметров запуска - адреса и порта
SRV_PORT_KEY = '-p'
SRV_ADDR_KEY = '-a'
